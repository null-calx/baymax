...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "C-c t") 'gptel-menu)

  (setq gptel-model 'gpt-5-mini
        gptel--known-backends nil
        baymax-gptel-github-copilot (gptel-make-gh-copilot "Copilot")
        baymax-gptel-openai (gptel-make-openai "OpenAI"
                              :host "api.openapi.com"
                              ...
                              :models '("gpt-3.5-turbo" "gpt-4o"
                                        ...
                                        "gpt-5.1" "gpt-5.2"))
        gptel-backend baymax-gptel-github-copilot)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "C-c /") 'hideshowvis-minor-mode)

  (with-eval-after-load 'hideshowvis
    (define-fringe-bitmap 'hideshowvis-hideable-marker [#x66 #x3c #x18])
    (define-fringe-bitmap 'hideshowvis-hidden-marker [#x18 #x3c #x66]))
#+END_SRC
